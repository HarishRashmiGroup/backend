...
exports.otpTemplate = exports.commentMailTemplate = exports.createTaskEmailTemplate = void 0;
const task_entity_1 = require("../Tasks/entities/task.entity");
const createTaskEmailTemplate = (beforeTask, afterTask, action) => {
    ...
    const createTaskCard = (task, label) => {
...
exports.createTaskEmailTemplate = createTaskEmailTemplate;
const commentMailTemplate = (description, commenterName, taskDescription) => {
    const template = `
      <!DOCTYPE html>
      <html>
      <body style="
...
exports.commentMailTemplate = commentMailTemplate;
